...
var StepItem = styled_components_1.default.a(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  text-decoration: none;\n  color: ", ";\n  font-weight: ", ";\n\n  & svg {\n    fill: ", ";\n  }\n\n  &.active {\n    color: ", ";\n    font-weight: ", ";\n  }\n  &:hover {\n    color: ", ";\n  }\n"], ["\n  text-decoration: none;\n  color: ", ";\n  font-weight: ", ";\n\n  & svg {\n    fill: ", ";\n  }\n\n  &.active {\n    color: ", ";\n    font-weight: ", ";\n  }\n  &:hover {\n    color: ", ";\n  }\n"])), theme_1.colors.black.hint, theme_1.fontWeights.demiLight, theme_1.colors.blue.deep, theme_1.colors.blue.deep, theme_1.fontWeights.medium, theme_1.colors.blue.deep);
...
var Step = /** @class */ (function (_super) {
    ...
    Step.prototype.renderStep = function (items, current) {
        ...
        var stepItems = items.map(function (item, index) {
            return React.createElement(StepWrap, { className: "step-" + items.length, key: index },
                ...
                React.createElement(StepItem, { className: index == (current - 1) ? "active" : "", href: item.link, onClick: item.callback },
    ...
    Step.prototype.render = function () {
        ...
        return (React.createElement(StyledStep, null, this.renderStep(items, current)));
    };
    Step.defaultProps = {
        items: [],
        current: 1
