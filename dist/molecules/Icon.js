...
var getIcons = function (fill, name) {
    var icons = {
        ...
        "personal": {
            width: 24,
            height: 24,
            path: React.createElement("g", { fillRule: "nonzero", stroke: fill },
