...
var Tooltip = /** @class */ (function (_super) {
    ...
    Tooltip.prototype.render = function () {
        return (React.createElement(StyledTooltip, null,
            this.props.children,
            React.createElement(TooltipText, __assign({ className: this.props.placement }, this.props), this.nl2br(this.props.text))));
    };
