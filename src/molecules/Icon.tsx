...
export const Icon: React.SFC<Props> = (props) => {
  const fill = getValueFromTheme(colors, props.fill);
  const ic = getIcons(fill, props.name);
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={ic.width * props.scale} height={ic.height * props.scale} viewBox={`0 0 ${ic.width} ${ic.height}`}>
...
///////////////////////////////////////
const getIcons = (fill: string, name: string) => {
  const icons: any = {
    "arrow-down": {
      width: 24,
      height: 24,
      path: <path fill={fill} d="M12 16.485l9.192-9.192a1 1 0 0 1 1.415 1.414l-9.9 9.9a1 1 0 0 1-1.414 0l-9.9-9.9a1 1 0 1 1 1.415-1.414L12 16.485z" />
    },
    "arrow-left": {
      width: 24,
      height: 24,
      path: <path fill={fill} d="M8.243 12.314l7.778-7.778a1 1 0 1 0-1.414-1.415L6.12 11.607a1 1 0 0 0 0 1.414l8.486 8.485a1 1 0 1 0 1.414-1.414l-7.778-7.778z" />
    },
    "arrow-right": {
      width: 24,
      height: 24,
      path: <path fill={fill} d="M16.385 12.314L8.607 4.536A1 1 0 1 1 10.02 3.12l8.485 8.486a1 1 0 0 1 0 1.414l-8.485 8.485a1 1 0 1 1-1.414-1.414l7.778-7.778z" />
    },
    "arrow-up": {
      width: 24,
      height: 24,
      path: <path fill={fill} d="M12 7.515l9.192 9.192a1 1 0 0 0 1.415-1.414l-9.9-9.9a1 1 0 0 0-1.414 0l-9.9 9.9a1 1 0 1 0 1.415 1.414L12 7.515z" />
    },
    "back": {
      width: 24,
      height: 24,
      path: <g fill={fill} transform="matrix(-1 0 0 1 24 0)">
    ...
    "close": {
      ...
      path: <React.Fragment>
        ...
        <path fill={fill} d="M13.414 12l9.193 9.192a1 1 0 1 1-1.415 1.415L12 13.414l-9.192 9.193a1 1 0 0 1-1.415-1.415L10.586 12 1.393 2.808a1 1 0 0 1 1.415-1.415L12 10.586l9.192-9.193a1 1 0 1 1 1.415 1.415L13.414 12z" />
      </React.Fragment>
    },
    "crown": {
      width: 24,
      height: 24,
      path: <g fill={fill} fillRule="nonzero">
    ...
    "search": {
      width: 24,
      height: 24,
      path: <path fillRule="nonzero" stroke={fill} strokeWidth="2" d="M15.736 15.736l3.518 3.518-3.518-3.518zm3.518 3.518l3.202 3.202-3.202-3.202zm-3.518-3.518l-.316-.316.56-.7A8.001 8.001 0 0 0 4.07 4.072a8.001 8.001 0 1 0 10.65 11.909l.699-.56.316.316z" />
    },
    "selectall": {
      width: 24,
      height: 24,
      path: <path fill={fill} fillRule="nonzero" d="M8.811 10.522l-1.089 1.09 3.5 3.5L19 7.332l-1.089-1.089-6.689 6.69-2.41-2.412zm8.633 6.922H6.556V6.556h7.777V5H6.556C5.7 5 5 5.7 5 6.556v10.888C5 18.3 5.7 19 6.556 19h10.888C18.3 19 19 18.3 19 17.444v-6.222h-1.556v6.222z" />
    },
    "step": {
      width: 40,
      height: 40,
      path: <path fill={fill} d="M16.9 26.627l13.435-13.435a1 1 0 1 1 1.414 1.415L17.607 28.749a1 1 0 0 1-1.415 0l-8.485-8.486a1 1 0 1 1 1.414-1.414l7.778 7.778z" />
    },
    "upload": {
      width: 24,
      height: 24,
      path: <g fillRule="nonzero">
        <rect width="1" height="13" x="12" y="5" fill={fill} rx=".5" />
        <path fill={fill} d="M12.854 3.904l4.242 4.242a.5.5 0 1 1-.707.708L12.5 4.964l-3.89 3.89a.5.5 0 0 1-.706-.708l4.242-4.242a.5.5 0 0 1 .708 0z" />
        <path stroke={fill} strokeLinecap="round" strokeLinejoin="round" d="M2 14v4a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-4" />
      </g>
    },
    "reload": {
      width: 24,
      ...
      path: <g fill="none" fillRule="evenodd">
        <path stroke={fill} strokeLinecap="round" strokeWidth="2" d="M19.816 1.818v4.908h-4.909" />
        <path stroke={fill} strokeLinecap="round" strokeWidth="2" d="M2.363 11.635a9.27 9.27 0 0 1 9.271-9.272 9.248 9.248 0 0 1 7.805 4.265M3.454 21.452v-4.909h4.908" />
        <path stroke={fill} strokeLinecap="round" strokeWidth="2" d="M20.907 11.635a9.27 9.27 0 0 1-9.272 9.271 9.25 9.25 0 0 1-7.804-4.264" />
      </g>
    },
    "add": {
      width: 24,
      height: 24,
      path: <path fill={fill} d="M11 11V3a1 1 0 0 1 2 0v8h8a1 1 0 0 1 0 2h-8v8a1 1 0 0 1-2 0v-8H3a1 1 0 0 1 0-2h8z" />
    },
    "delete": {
      width: 20,
      height: 20,
      path: <path fill={fill} fillRule="nonzero" d="M10 8.821L6.464 5.286a.833.833 0 1 0-1.178 1.178L8.821 10l-3.535 3.536a.833.833 0 1 0 1.178 1.178L10 11.179l3.536 3.535a.833.833 0 0 0 1.178-1.178L11.179 10l3.535-3.536a.833.833 0 0 0-1.178-1.178L10 8.821zM10 20C4.477 20 0 15.523 0 10S4.477 0 10 0s10 4.477 10 10-4.477 10-10 10z" />
    },
    "doublearrow-left": {
      width: 24,
      height: 24,
    ...
    "home": {
      width: 24,
      height: 24,
      path: <g fill={fill} fillRule="nonzero" transform="translate(2 3)">
    ...
    "ascending": {
      width: 24,
      height: 24,
      path: <g fill={fill} transform="translate(1 5)">
    ...
    "descending": {
      width: 24,
      height: 24,
      path: <g fill={fill} transform="translate(1 3)">
    ...
    "personal": {
      width: 24,
      height: 24,
      path: <g fillRule="nonzero" stroke={fill}>
