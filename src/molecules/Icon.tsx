...
const getIcons = (fill: string, name: string) => {
  const icons: any = {
    ...
    "home": {
      width: 24,
      height: 24,
      path: <g fill={fill} fillRule="nonzero" transform="translate(0 2)">
        <rect width="22" height="2" x=".766" y="17.643" rx="1" />
        <path d="M17.792 7.417l-6.08-5.101L5.72 7.344a1 1 0 0 1 .046.299v10h-2v-8.66l-2.123 1.782A1 1 0 1 1 .357 9.233L10.932.36l.002-.003c.2-.239.489-.36.778-.357a.998.998 0 0 1 .781.36l10.574 8.873a1 1 0 1 1-1.285 1.532l-2.016-1.691v8.569h-2v-10c0-.078.009-.153.026-.226z" />
        <path d="M11.766 11.643a1 1 0 0 1 1 1v5h-2v-5a1 1 0 0 1 1-1z" />
      </g>
    },
  };
